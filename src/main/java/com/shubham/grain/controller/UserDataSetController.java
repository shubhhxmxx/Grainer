...
public class UserDataSetController {
	...
	@PostMapping("/readCsv")
	public ResponseEntity<UserDataSetDTO> readCsv(@RequestParam("file") MultipartFile file,@RequestParam("userId") Integer userId, @RequestParam("useAi") Boolean useAi){
		UserDataSetDTO userDataSetDTO=userDataSetService.uploadCsv(userId, file,useAi);
